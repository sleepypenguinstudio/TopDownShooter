...
public class BinarySpacePartitioner
{
    ...
    private Line GetLineDividingSpace(Vector2Int bottomLeftAreaCorner, Vector2Int topRightAreaCorner, int roomWidthMin, int roomLengthMin)
    {
        ...
        {
            orientaion = (Orientation)(Random.Range(0, 2));
        }else if (widthStatus)
        {
            orientaion = Orientation.Vectical;
        }
        else
        {
            orientaion = Orientation.Horizontal;
        }
        return new Line(orientaion, GetCoordinatesForOrientation(orientaion,bottomLeftAreaCorner,topRightAreaCorner,roomWidthMin,roomLengthMin));
    }

    private Vector2Int GetCoordinatesForOrientation(Orientation orientaion,
